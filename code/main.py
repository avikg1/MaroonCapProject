...
attributes = ["trailingPE", "impliedSharesOutstanding"]
...
merged_ = merged_df.dropna(subset= attributes)
...
merged_df['MarketCap'] = merged_df['start'] * merged_df['impliedSharesOutstanding']
